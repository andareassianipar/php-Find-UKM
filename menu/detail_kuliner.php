...
<?php                  
            ...
            // $query1 = mysqli_query($connect, "SELECT * FROM menu_kuliner JOIN produk ON id_kuliner = id WHERE id='$_GET[id]'");
            ?>
    ...
    <div class="container">
      ...
      <h1 class="mt-4 mb-3"><?php echo $data['nama_ukm']; ?>
        ...
        <?php
                  if(isset($_SESSION['username'])){
                    if($_SESSION['username']=='admin') {
                      echo "<a href='../proses/add_kuliner/ubah.php?id=".$data['id']."'><button style='float: right;margin-top: 10px' class='btn btn-primary'>Ubah</button></a>";
                    }
                    else{}
                  }
                ?>
      ...
      <div class="row">
        ...
        <div class="carousel-inner" role="listbox" style="width: 100%; height: 90%"> 
          ...
          <div class="carousel-item"> <img width="100%" src="../img/kuliner/mtb.png">
            <div class="carousel-caption d-none d-md-block">
            </div>
          </div>
        </div>
            ...
            <div role="tabpanel" class="tab-pane in active">
              <table border="0">
                <tr>
                  ...
                  $harga = $row['harga'];
                  ?>
                  <td style="width: 200px; text-align: left"><?php echo $menu?></td>
                  <td style="width: 200px; text-align: right"><?php echo $harga?></td>
                </tr>
                <?php } ?>
              </table>
              <div>
                <?php
                  if(isset($_SESSION['username'])){
                    if($_SESSION['username']!='admin') {
                      echo "<a href='../pemesanan.php?id=".$data['id']."'><button style='float: right;margin-top: 10px' class='btn btn-primary'>Pesan</button></a>";
                    }
                    else{}
                  }
                ?>
