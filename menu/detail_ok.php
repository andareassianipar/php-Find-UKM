...
<?php                  
            ...
            $query1 = mysqli_query($connect, "SELECT * FROM menu_ok JOIN produk ON id_ok = id WHERE id='$_GET[id]'");
            ?>
    ...
    <div class="container">
      ...
      <h1 class="mt-4 mb-3"><?php echo $data['nama_ukm']; ?>
        ...
        <?php
                  if(isset($_SESSION['username'])){
                    if($_SESSION['username']=='admin') {
                      echo "<a href='../proses/add_oleh_khas/ubah.php?id=".$data['id']."'><button style='float: right;margin-top: 10px' class='btn btn-primary'>Ubah</button></a>";
                    }
                    else{}
                  }
                ?>
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item">
          <a href="../olehkhas.php">Oleh-oleh Khas</a>
        </li>
            ...
            <div role="tabpanel" class="tab-pane in active">
              <table border="0">
                <tr>
                  ...
                  $harga = $row['harga'];
                  ?>
                  <td style="width: 200px; text-align: left"><?php echo $sedia?></td>
