...
<?php                  
            ...
            $query1 = mysqli_query($connect, "SELECT * FROM menu_sewa JOIN produk ON id_sewa = id WHERE id='$_GET[id]'");
            ?>
    ...
    <div class="container">
      ...
      <h1 class="mt-4 mb-3"><?php echo $data['nama_ukm']; ?>
        ...
        <?php
                  if(isset($_SESSION['username'])){
                    if($_SESSION['username']=='admin') {
                      echo "<a href='../proses/add_penyewaan/ubah.php?id=".$data['id']."'><button style='float: right;margin-top: 10px' class='btn btn-primary'>Ubah</button></a>";
                    }
                    else{}
                  }
                ?>
