...
<?php                  
            ...
            $query1 = mysqli_query($connect, "SELECT * FROM menu_ukm JOIN produk ON id_ukm = id WHERE id='$_GET[id]'");
            ?>
    ...
    <div class="container">
      ...
      <h1 class="mt-4 mb-3"><?php echo $data['nama_ukm']; ?>
        ...
        <?php
                  if(isset($_SESSION['username'])){
                    if($_SESSION['username']=='admin') {
                      echo "<a href='../proses/add_ukm/ubah.php?id=".$data['id']."'><button style='float: right;margin-top: 10px' class='btn btn-primary'>Ubah</button></a>";
                    }
                    else{}
                  }
                ?>
      ...
      <div class="row">
        ...
        <div class="col-lg-5 mb-4">
          ...
          <ul class="nav nav-tabs" role="tablist">
            <li class="nav-item">
              <a class="nav-link active" href="#1" role="tab" data-toggle="tab">1</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="#2" role="tab" data-toggle="tab">2</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="#3n" role="tab" data-toggle="tab">3</a>
            </li>
          </ul>
          ...
          <div class="tab-content">
            <div role="tabpanel" class="tab-pane in active" id="1">
              <table border="0">
                <tr>
                  <td style="text-align: left; width: 350px">1</td>
                  <td></td>
                <tr>
              </table>
            </div>
            <div role="tabpanel" class="tab-pane " id="2">
              <table border="0">
                <tr>
                  <td style="text-align: left; width: 350px">2</td>
                  <td></td>
                <tr>
              </table>
            </div>
            <div role="tabpanel" class="tab-pane " id="3">
              <table border="0">
                <tr>
                  <td style="text-align: left; width: 350px">3</td>
                <tr>
              </table>
            </div>
          </div>
