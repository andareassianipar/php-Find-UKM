...
<html lang="en">
  ...
  <head>
    ...
    <title>Tambah Kuliner - FindUKM</title>
  ...
  <body>
    ...
    <div class="container">
      ...
      <h1 class="mt-4 mb-3">Tambah Kuliner
      </h1>
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Kuliner</li>
              ...
              <a href="../../kuliner.php"><input style="float: right;" type="button" class="btn btn-primary" value="Batal"></a>
              </form></br>
